...
/// <summary>
/// The PlatformGrid class can be used for efficient procedural generation of the tilemap of a level.
/// However, in the current version of the game there's no 'floor' under mover's feet.
/// </summary>
[ExecuteInEditMode]
